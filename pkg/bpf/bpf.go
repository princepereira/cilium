...
var (
	preAllocateMapSetting uint32 = bpfabi.NoPrealloc
...
func DisableMapPreAllocation() {
	atomic.StoreUint32(&preAllocateMapSetting, bpfabi.NoPrealloc)
}
...
func EnableMapDistributedLRU() {
	atomic.StoreUint32(&noCommonLRUMapSetting, bpfabi.NoCommonLRU)
}
